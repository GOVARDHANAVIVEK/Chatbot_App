data = {
    "text": [
        ...
        "that's all","nothing else","no more questions","I'm done","that's it",
        "I'm good","all set","I'm okay","no further help needed","I don't need anything else",
        "nothing more","I'm fine, thanks","no, I'm good","no, that's everything","I'm all set",
        "nope, that's it"
    ],
    "intent": [
        ...
        #fetch appointment
        'fetch_appointment','fetch_appointment','fetch_appointment','fetch_appointment','fetch_appointment','fetch_appointment',

        "greetings", "greetings", "greetings", "greetings", "greetings", "greetings",
        "greetings", "greetings", "greetings", "greetings", "greetings", "greetings",

        "end_greet","end_greet","end_greet","end_greet","end_greet","end_greet",
        "end_greet","end_greet","end_greet","end_greet","end_greet","end_greet",
        "end_greet","end_greet","end_greet","end_greet"
