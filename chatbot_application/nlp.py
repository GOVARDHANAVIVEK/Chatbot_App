...
def preprocess_text(text):
    ...
    # Add a greeting response if the intent is a greeting
    if intent == 'greetings':
        greeting_vocab = ['hello', 'hi', 'greetings', 'hey', 'hola', "Hi! How’s it going?","Hola! How can I be of service?","Greetings! How can I help you today?","Hi there! What can I do for you?"]
        random_ = random.choice(greeting_vocab)
        print(random_)
        context_greet['greet'] = random_
        context_greet['flow'] = "greeting_flow"
        print(context_greet)
        return context_greet
    elif intent == 'end_greet':
        thanking_vocab = [
    "Thank you for using our service. Have a great day!",
    "If you need anything else, feel free to ask. Goodbye!",
    "Take care! We're here if you need any further assistance.",
    "Goodbye! Let us know if you have any more questions.",
    "Thanks for chatting with us. Have a wonderful day!",
    "We appreciate your time. Reach out if you need anything more!",
    "It was a pleasure helping you. See you next time!",
    "Goodbye! Don't hesitate to contact us again.",
    "Thank you! We're here whenever you need us. Have a great day!",
    "Hope I was able to assist you well. Farewell!"
]
        random_ = random.choice(thanking_vocab)
        print(random_)
        context_greet['greet'] = random_
        context_greet['flow'] = "thanking_flow"
        print(context_greet)
        return context_greet
